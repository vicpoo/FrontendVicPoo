...
const Menu = () => {
  ...
  <Text className="text-center text-lg text-gray-800 mt-2">
    nos encargamos que nuestras cosechas sean las mejores para mejor experiencia y degustacion al cliente.
  </Text>
</div>
...
<div className="flex flex-col items-center">
  <Image src="public/Imagenes/Tostado.jpg" alt="Doracion del café" className="w-49 h-50 rounded-full object-cover shadow-lg" />
...
<div className="flex flex-col items-center">
  <Image src="public/Imagenes/FertilizanteC.jpg" alt="Recolección de Café" className="w-49 h-50 rounded-full object-cover shadow-lg" />
  <h3 className="text-xl font-semibold text-gray-700 mt-4">Fertilizantes y más..</h3>
  <Text className="text-center text-lg text-gray-800 mt-2">
  Café de especialidad que ya venden los productores y los embases de refresco contienen lixiviados (abonos organicos líquidos) que usan los productores para no aplicar productos químicos y producir de manera agroecologíco.
  </Text>
</div>
...
<div className="flex flex-col items-center">
  <Image src="public/Imagenes/cafe00111.jpg" alt="Recolección de Café" className="w-49 h-50 rounded-full object-cover shadow-lg" />
  <h3 className="text-xl font-semibold text-gray-700 mt-4">Exhibicion de Café</h3>
  <Text className="text-center text-lg text-gray-800 mt-2">
